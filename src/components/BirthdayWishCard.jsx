        ...
        <div ref={frameRef} style={{
          ...
          <div style={{
            ...
            <p className="reveal-el" style={{
              ...
              "Selamat ulang tahun yang ke-15 yaa Caca sayang. Semoga di usiamu yang sekarang kamu selalu diberikan kesehatan, kebahagiaan, kemudahan dalam segala urusan, dan tercapai semua cita-cita serta impianmu. Jangan lupa bahagia yaa sayang, you deserve all the love and happiness in the world! ❤️"
            </p>
